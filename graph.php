                ...
                <table class="table table-striped invoice-table">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Other Health Facility</th>
                            <th>Non Public Health Fcility</th>
...
<td><?php echo $res['public'] ?> </td>
<td><?php echo $res['community'] ?> </td>
<td><?php echo $res['other health facility'] ?> </td>
<td><?php echo $res['non public health facility'] ?> </td>
...
include("pie.html"); ?>
            <div class="container content"><div id="chartContainer" style="height: 400px; width: 100%;"></div>
                    ...
                    <div class="copyright">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="index-2.html">
                                        <!-- <img class="pull-right" id="logo-footer" src="assets/img/logo.jpg" alt="">-->
                                    </a>
                                </div>
                            </div>
                        </div>
